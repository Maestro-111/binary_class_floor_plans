...
def save_to_dataset(data_dir = "data",dataset_dir = "Dataset_original"):
    ...
    for image_type in os.listdir(data_dir):
        ...
        type_dir = os.path.join(data_dir, image_type)  # data/survey or floor plan
...
def augementation(survey_images_dir,floors_images_dir,output_dir):
    ...
    floors_images_len = count_files_in_directory(floors_images_dir)
    survey_images_len = count_files_in_directory(survey_images_dir)
